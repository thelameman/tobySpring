								...
								<div class="wpb_column vc_column_container vc_col-sm-12">
									<div class="vc_column-inner ">
										<div class="wpb_wrapper">
											<h2
												style="text-align: left; font-family: Roboto; font-weight: 300; font-style: normal"
							  ...
							  제5조 (서비스의 제공 및 변경)
								...
								<div class="wpb_column vc_column_container vc_col-sm-4">
									<div class="vc_column-inner ">
										<div class="wpb_wrapper">
											<div class="feature-box equal-height "
												style="height: 363px; width: 400px; margin-left: 120px">
												<figure class="icon">
													<i class="fa fa-archive"></i>
												</figure>
												<aside class="description">
													<header>
														<h3>부동산 중개사무소 서비스 약관</h3>
													</header>
													<table>
														<tr>
															<td><textarea cols="30" rows="8"
																	style="overflow: scroll;">제1장 총칙

제1조 (목적)
본 약관은 (주)니가사는그집(이하 “회사”라 함)이 운영하는 인터넷 사이트 및 모바일 어플리케이션(이하 “니가사는그집”이라 함)에서 제공하는 부동산 매물 등록 서비스의 이용과 관련하여 회사와 중개업소의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제2조 (정의)
1. 니가사는그집: 회사가 컴퓨터 등 정보통신설비를 이용하여 서비스를 제공할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 인터넷 사이트 및 모바일 어플리케이션을 운영하는 사업자의 의미로도 사용합니다.
2. 이용자: 니가사는그집에 접속하여 본 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
3. 회원: 본 약관에 따라 회사와 이용계약을 체결하고 서비스를 이용하는 부동산중개업소를 말합니다. 회사는 서비스의 원활한 제공을 위해 회원의 등급을 회사 내부의 규정에 따라 나눌 수 있습니다.
4. 비회원: 회원으로 가입하지 않고 회사가 제공하는 서비스를 이용하는 자를 말합니다.
5. 아이디(ID): 회원의 식별과 서비스 이용을 위하여 회원이 설정하고 회사가 승인한 회원 본인의 이메일 주소를 말합니다.
6. 비밀번호: 회원의 동일성 확인과 회원정보의 보호를 위하여 회원이 설정하고 회사가 승인한 문자나 숫자의 조합을 말합니다.
7. 서비스: 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 회원이 이용할 수 있는 니가사는그집의 서비스를 의미합니다.
...
제4조 (약관의 해석)
1. 회사는 서비스운영을 위해 별도의 운영정책을 마련하여 운영할 수 있으며, 회사는 니가사는그집 인터넷 사이트 및 모바일 어플리케이션에 운영정책을 사전 공지 후 적용합니다.
2. 본 약관에서 정하지 아니한 사항이나 해석에 대해서는 니가사는그집 서비스 이용약관 및 별도의 운영정책, 관계법령 또는 상관례에 따릅니다.

제5조 (서비스의 제공 및 변경)
1. 부동산 매물 등록 서비스는 회원이 매물정보(부동산 거래정보 및 거래 물건에 대한 다양한 부가정보)를 직접 니가사는그집 인터넷 사이트 및 모바일 어플리케이션에 등록하여 이용자에게 노출할 수 있는 것을 말합니다.
2. 회사가 제공하는 서비스의 내용을 기술적 사양의 변경 등의 이유로 변경할 경우에는 그 사유를 이용자에게 통지하거나, 이용자가 알아볼 수 있도록 공지사항으로 게시합니다.
...
제8조 (회원가입 및 회원정보의 변경)
1. 회원의 가입은 회원이 되고자 하는 중개업소가 약관의 내용에 대하여 동의를 한 다음 회원 가입신청을 하고, 회사는 이러한 신청에 대하여 해당 중개업소로부터 중개업소 등록 여부를 확인할 수 있는 별도의 서면 등을 요청하여 확인 후 승낙함으로써 체결됩니다.
...
3) 가입신청자가 이전에 회원자격을 상실한 적이 있는 경우 (다만 회원자격 상실 후 회사가 필요하다고 판단하여 회원재가입 승낙을 얻은 경우에는 예외로 합니다.)
4) 회사로부터 회원자격 정지 조치 등을 받은 회원이 그 조치기간 중에 이용계약을 임의 해지 하고 재이용 신청을 하는 경우
5) 기타 회원으로 등록하는 것이 니가사는그집의 기술상 현저히 지장이 있다고 판단되는 경우
6) 본 약관에 위배되거나 위법 또는 부당한 이용신청임이 확인된 경우 및 회사가 합리적인 판단에 의하여 필요하다고 인정하는 경우
								...
								<div class="vc_column-inner ">
									<div class="wpb_wrapper">
										...
										<form role="form" id="form-create-account"
											...
											method="post" enctype="multipart/form-data" action="insertBroker">
											<!-- 		<input type="hidden" id="create_profile"
															name="create_profile" value="21ced4cccc" /><input
									s						type="hidden" name="_wp_http_referer"
											...
											<div class="form-group">
												<label for="custId">아이디:</label><input type="text"
													class="form-control" id="brokerId" name="brokerId" required>
												<!-- <input type="button"
																			id="idCheck" class="btn pull-right btn-default" value="중복확인"> <span id="result"></span> -->
											</div>
											<br>
											<!-- /.form-group -->
											<div class="form-group">
												<label for="name">대표자 명:</label><input type="text"
											...
											<div class="form-group">
												<label for="check-pw">패스워드 확인:</label><input type="password"
													class="form-control" id="check-pw" name="check-pw" required>
											</div>

											<div class="form-group">
												<label for="officeName">중개소 명:</label><input type="text"
													class="form-control" id="officeName" name="officeName"
													required>
											</div>

											<div class="form-group">
												<label for="address">중개소 주소:</label><input type="text"
													class="form-control" id="address" name="address" required>
											</div>
											<div class="form-group">
												<label for="officeTel">중개소 전화번호</label><input type="text"
													class="form-control" id="officeTel" name="officeTel"
													required>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label for="phone">대표자 휴대폰 번호:</label><input type="text"
													class="form-control" id="phone" name="phone"
													placeholder="'-'를 생략한 11자리를 입력해주세요" required>
											</div>
											<div class="form-group">
												<label for="pictures">중개소 사진:</label><input type="file"
													id="pictures" name="file" multiple accept="image/*" required>
												<br />
												<span>10M 이하의 사진만 허용 됩니다.</span>
											</div>
