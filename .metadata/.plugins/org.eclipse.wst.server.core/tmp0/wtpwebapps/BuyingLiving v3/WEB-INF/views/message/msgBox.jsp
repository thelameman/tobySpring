...
<link rel="alternate" type="application/rss+xml"
	title="Zoner &raquo; Timeline Comments Feed"
	href="http://themes.fruitfulcode.com/zoner/timeline/feed/" />
...
<link rel="canonical"
	href="http://themes.fruitfulcode.com/zoner/timeline/" />
<link rel='shortlink' href='http://themes.fruitfulcode.com/zoner/?p=99' />
<link rel="alternate" type="application/json+oembed"
	href="http://themes.fruitfulcode.com/zoner/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fthemes.fruitfulcode.com%2Fzoner%2Ftimeline%2F" />
<link rel="alternate" type="text/xml+oembed"
	href="http://themes.fruitfulcode.com/zoner/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fthemes.fruitfulcode.com%2Fzoner%2Ftimeline%2F&#038;format=xml" />
<style type="text/css">
.recentcomments a {
	display: inline !important;
	padding: 0 !important;
...
})('//themes.fruitfulcode.com/zoner/?wordfence_logHuman=1&hid=ABCABA965A5B08B66C9884C224CE4879');
</script>
<script type="text/javascript">
			var _gaq = _gaq || [];
...
<body
	class="page page-id-99 page-template-default group-blog masthead-fixed page-sub-page page-legal wpb-js-composer js-comp-ver-4.11.2 vc_responsive"
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<article id="post-99"
								class="post-99 page type-page status-publish hentry">
								<section id="content" class="content">
									<header class="">
										<h1>
											<img src="resources/img/msg.png" width="40px" height="35px">&nbsp;메시지함
										</h1>
									</header>
													...
													<div class="wpb_column vc_column_container vc_col-sm-12">
														<div class="vc_column-inner ">
															<div class="wpb_wrapper">
																<section id="timeline-25" class="timeline">
																	<c:if test="${empty msgBox}">
																		<p style="text-align: center;">쪽지가 존재 하지 않습니다.</p>

																	</c:if>
																	<c:if test="${not empty msgBox}">
																		<c:forEach items="${msgBox}" var="msg">
																			<article id="timeline-item-92" class="timeline-item">
																				<div class="row">
																					<div class="col-md-1">
																						<div class="circle">
																							<figure class="dot"></figure>
																							<c:set var="msgDate" value="${msg.msgRegDate}" />
																							<div class="date" style="width: 70px;">${fn:substring(msgDate,2,10)}</div>
																						</div>
																					</div>
																					<div class="col-md-11">
																						<div class="wrapper">
																							<header>
																						<%-- 	<c:param name="sqlVal" value="${loginId}" /> --%>
																							<c:if test="${msg.receiveId eq loginId }">
																								<h3>${msg.sendId}</h3>
																								</c:if>
																								<c:if test="${msg.receiveId ne loginId }">
																								<h3>${msg.receiveId}</h3>
																								</c:if>
																							</header>
																							<p>${msg.msgText}</p>
																							<a
																								href="selectOneMsgBox?sendId=${msg.sendId}&receiveId=${msg.receiveId}"
																								style="bottom: 180px; right: 400px; text-align: right;">
																								<!-- <a href="oneMsgBoxView"	style="bottom: 180px; right: 400px; text-align: right;"  > -->
																								자세히보기
																							</a>
																						</div>
																					</div>
																	...
																	<a class="btn pull-right btn-default"
																		style="margin-left: 15px;" href="sendMsgView?sendId=${loginId}"
																		style="position: fixed; top: 180px; right: 400px">쪽지보내기</a>
																</section>
															</div>
														</div>
													</div>
