	...
	<div class="row">
		<section class="agent-form">
			<aside id="" class="agent-info clearfix">
				<figure>
					<img alt="" src="/img/${brokerPic.pic_temp}">
				</figure>
				<div class="agent-contact-info">
					<header>
						<h2>
							<dl>
								<dt>부동산 :</dt>
								<dd style="text-align: left;">${brokerInfo.officeName}</dd>
							</dl>
						</h2>
						<header>
							<dl>
								<dt>ID :</dt>
								<dd>
									<a href="" id="message" sendId="${loginId}"
										receiveId="${brokerInfo.brokerId}">${brokerInfo.brokerId}</a>
								</dd>
								<dt>사무실 연락처 :</dt>
								<dd>${brokerInfo.officeTel}</dd>
								<dt>소속 공인중개사 :</dt>
								<dd>${brokerInfo.name}</dd>
								<dt>개인 연락처 :</dt>
								<dd>${brokerInfo.phone}</dd>
								<dt>사무실 주소 :</dt>
								<dd>${brokerInfo.address}</dd>
								<dt>E-mail:</dt>
								<dd>
									<a href="mailto:'+data.broker.email+'">${brokerInfo.email}</a>
								</dd>
							</dl>
							<hr>
						</header>
