...
<body class="page page-id-468 page-template-default group-blog masthead-fixed page-sub-page page-legal wpb-js-composer js-comp-ver-4.9 vc_responsive" data-offset="90" data-target=".navigation" data-spy="scroll" id="page-top">
	<div id="page" class="hfeed site wrapper">
		...
		<div class="navigation">
			...
			<div class="container">
				<div class="contact">
											<figure><strong>Phone:</strong>810-991-3842</figure>
																<figure><strong>Email:</strong><a href="mailto:zoner@example.com">zoner@example.com</a></figure>
									</div>
				<div class="user-area">
					<div class="actions">
						
															<a class="promoted" href="http://themes.fruitfulcode.com/zoner/register/" class="register"><strong>Register</strong></a>
							
							
															<a href="http://themes.fruitfulcode.com/zoner/sign-in/" class="sing-in">Sign In</a>
				...
				<header class="navbar" id="top" role="banner">
					<div class="navbar-header">
						...
						<a class="navbar-brand nav logo" href="http://themes.fruitfulcode.com/zoner/" title="Real Estate WordPress Theme" rel="home"><img style="width:94px; height:22px;" width="94px" height="22px" src="http://themes.fruitfulcode.com/zoner/wp-content/themes/zoner/includes/admin/zoner-framework/../zoner-options/patterns/images/logo.png" alt="Real Estate WordPress Theme"/></a><a class="navbar-brand nav logo retina" href="http://themes.fruitfulcode.com/zoner/" title="Real Estate WordPress Theme" rel="home"><img style="width:94px; height:22px;" width="94px" height="22px" src="http://themes.fruitfulcode.com/zoner/wp-content/themes/zoner/includes/admin/zoner-framework/../zoner-options/patterns/images/logo@2x.png" alt="Real Estate WordPress Theme"/></a>					</div>
					<nav class="collapse navbar-collapse bs-navbar-collapse navbar-right"><ul id="menu-main-menu-header" class="nav navbar-nav"><li id="menu-item-54" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children has-child"><a href="http://themes.fruitfulcode.com/zoner/homepage/">Homepage</a>
<ul class="sub-menu list-unstyled child-navigation">
	<li id="menu-item-3609" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Google Map</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-1931" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/1/">Google Map Full Screen</a></li>		<li id="menu-item-1933" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/3/">Google Map Fixed Navigation</a></li>		<li id="menu-item-1932" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/2/">Google Map Fixed Height</a></li>		<li id="menu-item-1934" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/4/">Google Map Horizontal Search</a></li>		<li id="menu-item-1935" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/5/">Google Map Advanced Horizontal Search</a></li>	</ul>
</li>	<li id="menu-item-3610" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Open Street Map</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-1936" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/6/">OSM Full Screen Map</a></li>		<li id="menu-item-1937" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/7/">OSM Fixed Height</a></li>		<li id="menu-item-1938" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/8/">OSM Fixed Navigation</a></li>		<li id="menu-item-1939" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/9/">OSM Horizontal Search</a></li>		<li id="menu-item-1940" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/10/">OSM Advanced Horizontal Search</a></li>	</ul>
</li>	<li id="menu-item-3611" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Property Slider</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-1941" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/11/">Property Slider</a></li>		<li id="menu-item-1942" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/12/">Property Slider &#038; Search Box</a></li>		<li id="menu-item-1943" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/13/">Property Slider &#038; Horizontal Search</a></li>		<li id="menu-item-1944" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/home_v/14/">Property Slider &#038; Advanced Horizontal Search</a></li>	</ul>
</li>	<li id="menu-item-3616" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/home-with-revolution/">Slider Revolution</a></li></ul>
</li><li id="menu-item-400" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Agents &#038; Agencies</a>
<ul class="sub-menu list-unstyled child-navigation">
	<li id="menu-item-402" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/agents-listing/">Agents Listing</a></li>	<li id="menu-item-1976" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="http://themes.fruitfulcode.com/zoner/author/ilyapavlov/">Agent detail</a></li>	<li id="menu-item-412" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/agencies-listing/">Agencies Listing</a></li>	<li id="menu-item-1790" class="menu-item menu-item-type-post_type menu-item-object-agency"><a href="http://themes.fruitfulcode.com/zoner/agency/lighthouse-estate/">Agency detail</a></li></ul>
</li><li id="menu-item-105" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children has-child"><a href="http://themes.fruitfulcode.com/zoner/properties/">All Properties</a>
<ul class="sub-menu list-unstyled child-navigation">
	<li id="menu-item-3632" class="menu-item menu-item-type-post_type menu-item-object-property"><a href="http://themes.fruitfulcode.com/zoner/property/30-warner-st/">Property detail</a></li>	<li id="menu-item-3646" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/properties-in-london/">Properties in London</a></li>	<li id="menu-item-2444" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/for-sale/">For sale</a></li>	<li id="menu-item-2443" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/for-rent/">For rent</a></li>	<li id="menu-item-2100" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/property-grid-listing/">Property grid listing</a></li>	<li id="menu-item-2101" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/property-lines-listing/">Property lines listing</a></li>	<li id="menu-item-2102" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/property-masonry-listing/">Property masonry listing</a></li></ul>
</li><li id="menu-item-401" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children has-child"><a href="#">Pages</a>
<ul class="sub-menu list-unstyled child-navigation">
	<li id="menu-item-1746" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/about-us/">About us</a></li>	<li id="menu-item-1975" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/pricing/">Pricing</a></li>	<li id="menu-item-56" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/faq/">FAQ&#8217;s</a></li>	<li id="menu-item-102" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/timeline/">Timeline</a></li>	<li id="menu-item-1791" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/create-an-account/">Create an Account</a></li>	<li id="menu-item-1792" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-468 current_page_item"><a href="http://themes.fruitfulcode.com/zoner/register/">Register</a></li>	<li id="menu-item-1793" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/sign-in/">Sign In</a></li>	<li id="menu-item-1747" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/terms-conditions/">Terms &#038; Conditions</a></li></ul>
</li><li id="menu-item-2258" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children has-child"><a href="http://themes.fruitfulcode.com/zoner/idx/">IDX</a>
<ul class="sub-menu list-unstyled child-navigation">
	<li id="menu-item-2259" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/dsidxpress-plugin/">dsIDXpress Plugin</a></li>	<li id="menu-item-2260" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/dsidxpress-single-listing-shortcode/">dsIDXpress Single Listing Shortcode</a></li></ul>
</li><li id="menu-item-2007" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children has-child"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/">Shortcodes</a>
<ul class="sub-menu list-unstyled child-navigation">
	<li id="menu-item-2763" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Content shortcodes</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-3054" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/accordion/">Accordion</a></li>		<li id="menu-item-2759" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/button/">Button</a></li>		<li id="menu-item-3052" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/call-to-action/">Call to Action</a></li>		<li id="menu-item-3055" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/contact-form-7/">Contact form 7</a></li>		<li id="menu-item-3066" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/custom-heading/">Custom Heading</a></li>		<li id="menu-item-3061" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/empty-space/">Empty Space</a></li>		<li id="menu-item-3060" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/faq-2/">FAQ</a></li>		<li id="menu-item-3065" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/flickr-widget/">Flickr Widget</a></li>		<li id="menu-item-3280" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/icon-2/">Icon</a></li>		<li id="menu-item-3047" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/line-chart/">Line Chart</a></li>		<li id="menu-item-3067" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/masonry-media-grid/">Masonry Media Grid</a></li>		<li id="menu-item-3048" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/media-grid/">Media Grid</a></li>		<li id="menu-item-3045" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/message-box/">Message Box</a></li>		<li id="menu-item-3046" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/pageable-container/">Pageable Container</a></li>		<li id="menu-item-3051" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/pie-chart/">Pie Chart</a></li>		<li id="menu-item-3044" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/post-grid/">Post Grid</a></li>		<li id="menu-item-3062" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/post-masonry-grid/">Post Masonry Grid</a></li>		<li id="menu-item-3056" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/progress-bar/">Progress Bar</a></li>		<li id="menu-item-3043" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/round-chart/">Round Chart</a></li>		<li id="menu-item-3058" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/section/">Section</a></li>		<li id="menu-item-3049" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/separator-2/">Separator</a></li>		<li id="menu-item-3053" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/separator-with-text/">Separator with Text</a></li>		<li id="menu-item-3064" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/single-image/">Single Image</a></li>		<li id="menu-item-3279" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/tabs/">Tabs</a></li>		<li id="menu-item-3063" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/text-block/">Text Block</a></li>		<li id="menu-item-3278" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/tour/">Tour</a></li>		<li id="menu-item-3059" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/video-player/">Video Player</a></li>	</ul>
</li>	<li id="menu-item-2764" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Social Shortcodes</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-3285" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/facebook-like/">Facebook Like</a></li>		<li id="menu-item-3283" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/google-button/">Google+ Button</a></li>		<li id="menu-item-3282" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/pinterest/">Pinterest</a></li>		<li id="menu-item-3284" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/tweetmeme-button/">Tweetmeme Button</a></li>	</ul>
</li>	<li id="menu-item-2765" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Structure Shortcodes</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-3281" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/raw-html/">Raw HTML</a></li>	</ul>
</li>	<li id="menu-item-2766" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children has-child"><a href="#">Zoner shortcodes</a>
<ul class="sub-menu list-unstyled child-navigation">
		<li id="menu-item-2834" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/advertising/">Advertising</a></li>		<li id="menu-item-2792" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/agencies-listing/">Agencies listing</a></li>		<li id="menu-item-2838" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/agents-listing/">Agents listing</a></li>		<li id="menu-item-2793" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/button-2/">Button</a></li>		<li id="menu-item-2835" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/ceo/">CEO</a></li>		<li id="menu-item-2845" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/faqs-section/">FAQ&#8217;s section</a></li>		<li id="menu-item-2837" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/fun-number/">Fun number</a></li>		<li id="menu-item-2836" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/google-maps/">Google maps</a></li>		<li id="menu-item-2789" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/icon/">Icon</a></li>		<li id="menu-item-2794" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/infobox/">Infobox</a></li>		<li id="menu-item-2791" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/info-message/">Info. message</a></li>		<li id="menu-item-3689" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/map-with-search/">Map with search</a></li>		<li id="menu-item-2843" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/partners/">Partners</a></li>		<li id="menu-item-2790" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/price-box/">Price box</a></li>		<li id="menu-item-3448" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/property-listing/">Property listing</a></li>		<li id="menu-item-2844" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/register-form/">Register form</a></li>		<li id="menu-item-2839" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/separator/">Separator</a></li>		<li id="menu-item-2841" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/sign-in-form/">Sign In form</a></li>		<li id="menu-item-2840" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/testimonials/">Testimonials</a></li>		<li id="menu-item-2842" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/shortcodes/timeline-section/">Timeline section</a></li>	</ul>
</li></ul>
</li><li id="menu-item-3078" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/blog/">Blog</a></li><li id="menu-item-3079" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="http://themes.fruitfulcode.com/zoner/contact-us/">Contact Us</a></li></ul></nav>														</header><!-- /.navbar -->
			</div><!-- /.container -->
		</div><!-- /.navigation -->
		<!-- end Navigation -->
							...
							<section class="vc_row wpb_row vc_row-fluid block">
								<div class="container">
									<div class="row">
										...
										<input type="hidden" id="create_profile" name="create_profile"
											value="21ced4cccc" /><input type="hidden"
											name="_wp_http_referer" value="/zoner/register/" />
										<div class="wpb_column vc_column_container vc_col-sm-4">
											<div class="vc_column-inner ">
												<div class="wpb_wrapper">
													...
													<form role="form" id="form-create-account"
														...
														method="post" action="">
														<input type="hidden" id="create_profile"
															name="create_profile" value="21ced4cccc" /><input
															type="hidden" name="_wp_http_referer"
															value="/zoner/register/" />
														<div class="radio" id="create-account-user">
															<label><input type="radio" id="account-type-user"
																value="1" name="account-type" required checked=checked>Regular
																User</label>
														</div>
														<div class="radio" id="agent-switch" data-agent-state="">
															<label><input type="radio"
																id="account-type-agent" value="2" name="account-type"
																required>Agent</label>
														</div>
														<div class="form-group">
															<label for="ca-login-name">Login ID:</label><input
																type="text" class="form-control" id="ca-login-name"
																name="ca-login-name" value="" required>
														</div>
														<!-- /.form-group -->
														<div class="form-group">
															<label for="ca-first-name">Name:</label><input
																type="text" class="form-control" id="ca-first-name"
																name="ca-first-name" value="" required>
														</div>
														<!-- /.form-group -->
														<div class="form-group">
															<label for="ca-last-name">PW:</label><input
																type="password" class="form-control" id="ca-full-name"
																name="ca-last-name" value="" required>
														</div>
														<!-- /.form-group -->
														<div class="form-group">
															<label for="ca-email">Confirm PW:</label><input type="password"
																class="form-control" id="ca-email" name="ca-email"
																value="" required>
														</div>
														<div class="form-group">
															<label for="ca-email">E-Mail:</label><input type="email"
																class="form-control" id="ca-email" name="ca-email"
																value="" required>
														</div>
														<div class="form-group">
															<label for="ca-email">Phone:</label><input type="text"
																class="form-control" id="ca-email" name="ca-email"
																value="" required>
														</div>
														<!-- /.form-group -->
														<div class="form-group clearfix">
															<button type="submit" class="btn pull-right btn-default"
																id="account-submit">Create an Account</button>
														</div>
														<!-- /.form-group -->
													</form>
													<hr>
													<div class="center">
														<figure class="note">By clicking the “Create an Account” button you agree with	our
															<a	href="http://themes.fruitfulcode.com/zoner/terms-conditions/"
