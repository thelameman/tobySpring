...
<script>
	$(function() {
		...
		$('#boardWriteView').on('click', function() {
			window.location.href = "qnaBoardWriteView";
		});
						...
						<div class="col-md-12 col-sm-12">
							...
							<article id="post-196"
								...
								<section id="content" class="content">
									<header class="">
										<a href="qnaBoardView?currentPage=1"><h1 style="margin: 30px;" >QnA 게시판 </h1></a>
									</header>
																...
																<div
																				...
																				<tbody>
																					<c:forEach items="${allBoardList }" var="board">
																						<tr>
																							<td>${board.boardNo }</td>
																							<td align="left">
																								<a href="qnaBoardDetail?boardNo=${board.boardNo }">${board.title }&nbsp; 
																	...
																	<div class="form-group ">
																		<div class="wrap_paging">
																			<form action="qnaBoardView" id="boardListForm"
																				method="get">
																				<div class="wrap_paging-navi">
																					<a href="javascript:movepage('${currentPage-1}')">
																						&lt; </a>
																					<c:forEach var="num"
																						begin="${pagenavi.startPageGroup}"
																						end="${pagenavi.endPageGroup}">
																						<c:if test="${num ==  pagenavi.currentPage}">
																							<a href="javascript:movepage(${num})"
																								class="selectedPn" style="color: purple;">[${num}]</a>
																						</c:if>
																						<c:if test="${num  !=  pagenavi.currentPage}">
																					...
																					<c:if
																						test="${searchField != null && searchText!=null}">
																	...
																	<div class="form-group" align="center">
																		<div class="input-group">
																			<form id="searchform" action="qnaBoardView"
																				method="get">
