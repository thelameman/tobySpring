		...
		$.ajax({
			...
			success: function(response){
				...
				$('header:last').append('<h3 style="font-size: 10pt;">'+msgRegDate+'</h3>');
			 	$('header:last').after('<p style="font-size: 10pt;">'+msgText+'</p>') 
				}
			}
			...
			<div class="container">
				<div class="row">
					...
					<a href="msgBoxView?sendId=${param.sendId}"
						style="position: absolute; top: 100px; right: 30px">메시지함으로</a>

					<form class="protected-form" action="sendMsg" method="post">
						<div class="panel panel-default">
							<div class="panel-heading">쪽지 보내기</div>
							<div class="panel-body">
								<c:if test="${!empty param.receivedId}">
									<label for="receiveId">수신아이디</label>
									<input type="text" width="150px" id="receiveId" name="receiveId" required="required" placeholder="수신아이디를 입력해주세요" value="${param.receivedId }">
								</c:if>
								<c:if test="${empty param.receivedId}">
									<label for="receiveId">수신아이디</label>
									<input type="text" width="150px" id="receiveId" name="receiveId" required="required" placeholder="수신아이디를 입력해주세요">
								</c:if>
								<input type="hidden" id="sendId" name="sendId" value="${param.sendId}"> 
								<label for="msgTextBox">메시지 입력</label> 
								<input class="msgText" name="msgText" id="msgTextBox" type="text" size="50" maxlength="600" />
								<!--  onblur="inputLengthCheck(this);"  -->
							</div>
							<div class="form-group clearfix">

								<div class="col-md-12">
									<input type="button" id="sBtn" name="sBtn" class="btn pull-right btn-default" value="보내기" />
								</div>
							</div>
						</div>
					</form>
...
<script type='text/javascript'
	src='http://themes.fruitfulcode.com/zoner/wp-content/plugins/dsidxpress/js/autocomplete.js?ver=201a87ed354d4d101903f99fa0251b3d'></script>
</body>
</html>