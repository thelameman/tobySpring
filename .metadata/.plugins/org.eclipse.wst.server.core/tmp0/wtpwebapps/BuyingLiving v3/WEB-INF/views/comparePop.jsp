...
<!--[if !(IE 7) | !(IE 8) ]><!-->
<html lang="en-US"
	class=" js_active  vc_desktop  vc_transform  vc_transform  js_active  vc_desktop  vc_transform  vc_transform "
	style="height: auto;">
<!--<![endif]-->
<head>
<script type="text/javascript"
	src="//apis.daum.net/maps/maps3.js?apikey=2266aed1d1ad1c546afc98030e20eba0&libraries=services"></script>
<meta charset="UTF-8">
...
<link rel="alternate" type="application/rss+xml" title="Zoner » Feed"
	href="http://themes.fruitfulcode.com/zoner/feed/">
<link rel="alternate" type="application/rss+xml"
	title="Zoner » Comments Feed"
	href="http://themes.fruitfulcode.com/zoner/comments/feed/">
<link rel="alternate" type="application/rss+xml"
	title="Zoner » Pricing Comments Feed"
	href="http://themes.fruitfulcode.com/zoner/pricing/feed/">
<script type="text/javascript" async=""
	src="http://www.google-analytics.com/ga.js"></script>
<script type="text/javascript">
...
<script
	src="http://themes.fruitfulcode.com/zoner/wp-includes/js/wp-emoji-release.min.js?ver=201a87ed354d4d101903f99fa0251b3d"
...
<link rel="stylesheet" type="text/css"
	href="resources/css/js_composer.min.css">
...
<link rel="canonical"
	href="http://themes.fruitfulcode.com/zoner/pricing/">
<link rel="shortlink"
	href="http://themes.fruitfulcode.com/zoner/?p=1972">
<link rel="alternate" type="application/json+oembed"
	href="http://themes.fruitfulcode.com/zoner/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fthemes.fruitfulcode.com%2Fzoner%2Fpricing%2F">
<link rel="alternate" type="text/xml+oembed"
	href="http://themes.fruitfulcode.com/zoner/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fthemes.fruitfulcode.com%2Fzoner%2Fpricing%2F&amp;format=xml">
<style type="text/css">
.recentcomments a {
	display: inline !important;
	padding: 0 !important;
...
<script type="text/javascript" async=""
	src="//themes.fruitfulcode.com/zoner/?wordfence_logHuman=1&amp;hid=2A428ED9E9265EDD123C79B39A90B7AC&amp;r=0.1896084847433619"></script>
<script type="text/javascript" charset="UTF-8"
	src="https://maps.googleapis.com/maps-api-v3/api/js/23/9/intl/ko_ALL/common.js"></script>
<script type="text/javascript" charset="UTF-8"
	src="https://maps.googleapis.com/maps-api-v3/api/js/23/9/intl/ko_ALL/util.js"></script>
<script type="text/javascript" charset="UTF-8"
	src="https://maps.googleapis.com/maps-api-v3/api/js/23/9/intl/ko_ALL/stats.js"></script>
<script type="text/javascript" async=""
	src="//themes.fruitfulcode.com/zoner/?wordfence_logHuman=1&amp;hid=2A428ED9E9265EDD123C79B39A90B7AC&amp;r=0.9016154340773015"></script>
</head>

<body
	class="page page-id-1972 page-template-default group-blog masthead-fixed page-sub-page page-legal wpb-js-composer js-comp-ver-4.11.2 vc_responsive"
	...
	<div id="page" class="hfeed site wrapper">
					...
					<div class="row">
						...
						<div class="vc_column-inner ">
							<div class="wpb_wrapper">
								...
								<div class="price"><figure>$20</figure><small> month</small></div>
								<ul>
									<li><strong>10&nbsp;</strong>Property</li>
									<li>Bookmarks</li>
									<li>Compare property</li>
									<li><strong>1&nbsp;</strong>Agent Profile</li>
									<li><strong>1&nbsp;</strong>Agency Profile</li>
									<li>Featured Properties</li>
								</ul>
									<a class="btn btn-default" href="http://themes.fruitfulcode.com/zoner/register/" title="Sign up!" target="_self">Sign up!</a>
								</div>
							/.price-box
							</div>
						</div>
													...
													<div class="wpb_column vc_column_container vc_col-sm-3">
														<div class="vc_column-inner ">
															<div class="wpb_wrapper">
																<div class="price-box">
																	<header>
																		<h2 style="font-size: 22px">${pt1.title }</h2>
																	</header>
																	<div class="price">
																		<figure>
																			<c:if test="${pt1.price>=10000}">
																				<fmt:formatNumber
																					value="${Math.floor(pt1.price/10000)}"
																					pattern="###" /> 억 <fmt:formatNumber
																					value="${pt1.price-Math.floor(pt1.price/10000)*10000} "
																					pattern="#" /> 만 원</c:if>
																			<c:if test="${pt1.price<10000}">
																				<fmt:formatNumber
																					value="${pt1.price-Math.floor(pt1.price/10000)*10000} "
																					pattern="#" />만 원</c:if>
																			<c:if test="${pt1.propertyType=='월세' }">
																				/ ${pt1.monthfee }
																			</c:if>

																		</figure>
																		<small><c:if test="${pt1.propertyType=='매매' }">
																				매매가
																			</c:if> <c:if test="${pt1.propertyType=='전세' }">
																				보증금
																			</c:if> <c:if test="${pt1.propertyType=='월세' }">
																				보증금 / 월세
																			</c:if></small>
																	</div>
																	<ul>
																		...
																		<li><strong>면적&nbsp;&nbsp;</strong>${pt1.area }&nbsp;
																			m<sup>2</sup></li>
																		<li><strong>등록일&nbsp;&nbsp;</strong>${pt1.inputdate.substring(0,10) }</li>
																		<li><strong>건축년도&nbsp;&nbsp;</strong>${pt1.builtyear }</li>
																		<li><strong>옵션&nbsp;&nbsp;</strong>${pt1.roomoption }</li>
																		<li><c:if test="${fn:length(pic1)>1 }">
																							...
																							<div class="property big">
																								<div id="property-1715" class="property">
																									<div class="property-image">
																										<a href="/img/${pic.pic_temp }"
																											title="${pic.pic }"><img
																											class="img-responsive"
																											src="/img/${pic.pic_temp }" alt="${pic.pic }"></a>
																									</div>
																									<div class="overlay">
																										<div class="info">
																											<span class="tag price">Download</span>
																											<h3 class="pictureSelect"
																												f='${pic.pic_temp }' p=${pic.pic }>${pic.pic}
																												&nbsp; &lt; Click Here &gt;</h3>
																										</div>
																									</div>
																								</div>
																			...
																			</c:if> <c:if test="${fn:length(pic1)==1 }">
																				<div class="popup-gallery">
																					<div class="property big">
																						<div id="property-1715" class="property">
																							<div class="property-image">
																								<a href="/img/${pic1[0].pic_temp }"
																									title="${pic1[0].pic }"><img
																									class="img-responsive"
																									src="/img/${pic1[0].pic_temp }"
																									alt="${pic1[0].pic }"></a>
																							</div>
																							<div class="overlay">
																								<div class="info">
																									<span class="tag price">Download</span>
																									<h3 class="pictureSelect"
																										f='${pic1[0].pic_temp }' p=${pic1[0].pic }>${pic1[0].pic}
																										&nbsp; &lt; Click Here &gt;</h3>
																								</div>
																							</div>
																						</div>
																		...
																		<li>
																			<section id="property-map">
																				<div class="property-detail-map-wrapper">
																					<div id="property-detail-map1"
																						class="property-detail-map"></div>
																				</div>
													...
													<script type="text/javascript">
        var mapContainer = document.getElementById('property-detail-map1'), // 지도를 표시할 div 
        mapOption = { 
            center: new daum.maps.LatLng('${pt1.lati}', '${pt1.longti}'), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
        ...
        // 마커가 표시될 위치입니다 
        var markerPosition  = new daum.maps.LatLng('${pt1.lati}', '${pt1.longti}'); 
													...
													<div class="wpb_column vc_column_container vc_col-sm-3">
														<div class="vc_column-inner ">
															<div class="wpb_wrapper">
																<div class="price-box">
																	<header>
																		<h2 style="font-size: 22px">${pt2.title }</h2>
																	</header>
																	<div class="price">
																		<figure>
																			<c:if test="${pt2.price>=10000}">
																				<fmt:formatNumber
																					value="${Math.floor(pt2.price/10000)}"
																					pattern="###" /> 억 <fmt:formatNumber
																					value="${pt2.price-Math.floor(pt2.price/10000)*10000} "
																					pattern="#" /> 만 원</c:if>
																			<c:if test="${pt2.price<10000}">
																				<fmt:formatNumber
																					value="${pt2.price-Math.floor(pt2.price/10000)*10000} "
																					pattern="#" />만 원</c:if>
																			<c:if test="${pt2.propertyType=='월세' }">
																				/ ${pt2.monthfee }
																			</c:if>

																		</figure>
																		<small><c:if test="${pt2.propertyType=='매매' }">
																				매매가
																			</c:if> <c:if test="${pt2.propertyType=='전세' }">
																				보증금
																			</c:if> <c:if test="${pt2.propertyType=='월세' }">
																				보증금 / 월세
																			</c:if></small>
																	</div>
																	<ul>
																		...
																		<li><strong>면적&nbsp;&nbsp;</strong>${pt2.area }&nbsp;
																			m<sup>2</sup></li>
																		<li><strong>등록일&nbsp;&nbsp;</strong>${pt2.inputdate.substring(0,10) }</li>
																		<li><strong>건축년도&nbsp;&nbsp;</strong>${pt2.builtyear }</li>
																		<li><strong>옵션&nbsp;&nbsp;</strong>${pt2.roomoption }</li>
																		<li><c:if test="${fn:length(pic2)>1 }">
																				<div class="popup-gallery">
																					<div id="owl-carousel-1"
																						class="owl-carousel featured-properties-carousel"
																						style="z-index: 5;">
																						<c:forEach var="pic" items="${pic2 }">
																							<div class="property big">
																								<div id="property-1716" class="property">
																									<div class="property-image">
																										<a href="/img/${pic.pic_temp }"
																											title="${pic.pic }"><img
																											class="img-responsive"
																			...
																			</c:if> <c:if test="${fn:length(pic2)== 1 }">
																				<div class="popup-gallery">
																					<div class="property big">
																						<div id="property-1716" class="property">
																							<div class="property-image">
																								<a href="/img/${pic2[0].pic_temp }"
																									title="${pic2[0].pic }"><img
																									class="img-responsive"
																									src="/img/${pic2[0].pic_temp }"
																									alt="${pic2[0].pic }"></a>
																							</div>
																							<div class="overlay">
																								<div class="info">
																									<span class="tag price">Download</span>
																									<h3 class="pictureSelect"
																										f='${pic2[0].pic_temp }' p=${pic2[0].pic }>${pic2[0].pic}
																										&nbsp; &lt; Click Here &gt;</h3>
																								</div>
																							</div>
																						</div>
																...
																<script type="text/javascript">
        var mapContainer = document.getElementById('property-detail-map2'), // 지도를 표시할 div 
        mapOption = { 
            center: new daum.maps.LatLng('${pt2.lati}', '${pt2.longti}'), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
        ...
        // 마커가 표시될 위치입니다 
        var markerPosition  = new daum.maps.LatLng('${pt2.lati}', '${pt2.longti}'); 
...
var ZonerGlobal = {"ajaxurl":"http:\/\/themes.fruitfulcode.com\/zoner\/wp-admin\/admin-ajax.php","domain":"http:\/\/themes.fruitfulcode.com\/zoner","is_mobile":"0","is_rtl":"0","is_general_page":"","is_agency_page":"","is_agent_page":"","source_path":"http:\/\/themes.fruitfulcode.com\/zoner\/wp-content\/themes\/zoner\/includes\/theme\/assets","start_lat":"40.7056308","start_lng":"-73.9780035","locations":[],"icon_marker":"http:\/\/themes.fruitfulcode.com\/zoner\/wp-content\/themes\/zoner\/includes\/admin\/zoner-framework\/..\/zoner-options\/patterns\/images\/icons\/marker.png","maps_zoom":"14","map_type":"0","min_price":"150","max_price":"1213333","default_currency":"$","header_variations":"0","zoner_ajax_nonce":"8d723b970e","zoner_message_send_text":"Thank you. Your message has been sent successfully.","zoner_message_faq_text":"Thank you for your vote.","zoner_default_compare_text":"Compare Your Property","zoner_pl_img_text_property":"Property","zoner_pl_img_text_featured":"Featured","zoner_pl_img_text_logo":"Logo","zoner_stripe_message_1":"Stripe process payment.","gm_or_osm":"0"};/* ]]> */</script>
	...
	<div id="dsidx_colorbox" class="" role="dialog" tabindex="-1"
		style="display: none;">
