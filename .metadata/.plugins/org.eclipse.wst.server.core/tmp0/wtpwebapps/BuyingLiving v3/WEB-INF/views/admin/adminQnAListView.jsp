								...
								<section id="content" class="content">
									<header class="">
										...
										<a href="approveBrokerList"
											...
											페이지</a>  <a href="approvePropertyList"
											style="position: fixed; top: 110px; right: 400px">매물 승인
											페이지</a> 
										<br>
									</header>
																			...
																			<table class="table table-striped">
																				<thead>
																					<tr id="QnAList"
																						...
																						<th width="20%;" style="text-align: center">글
																							작성 ID</th>
																						<th width="20%;" style="text-align: center">작성
																							일자</th>
																					</tr>
																				</thead>
																				<tbody>
																					<c:forEach items="${QnAList}" var="board">
																						<tr>
																							<td>${board.boardNo }</td>
																							<td><a
																								href="qnaBoardDetail?boardNo=${board.boardNo }">${board.title }</a></td>
																							<td>${board.userId }</td>
