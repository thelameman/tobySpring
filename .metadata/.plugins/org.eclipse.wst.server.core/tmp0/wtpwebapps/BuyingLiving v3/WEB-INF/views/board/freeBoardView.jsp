...
<script>
	$(function() {
		...
		$('#boardWriteView').on('click', function() {
			window.location.href = "freeBoardWriteView";
		});
	...
	function movepage(currentPage) {
		boardListForm.currentPage.value = currentPage;
...
<link rel="alternate" type="application/rss+xml" title="Zoner &raquo; Sign In Comments Feed" href="http://themes.fruitfulcode.com/zoner/sign-in/feed/" />
...
<link rel='stylesheet' id='zoner-gmap-style-css' href='http://themes.fruitfulcode.com/zoner/wp-content/themes/zoner/includes/admin/libs/theme-shortcodes/zoner-shortcodes/patternsCss/gmap.css?ver=201a87ed354d4d101903f99fa0251b3d'
															...
															<div class="wpb_wrapper">
																<div
																	...
																	<form>
																		...
																		<div class="table-responsive">
																			<table class="table table-striped">
																				...
																				<tbody>
																					<c:forEach items="${allBoardList }" var="board">
																						<tr>
																							<td>${board.boardNo }</td>
																							<td align="left">
																								<a href="freeBoardDetail?boardNo=${board.boardNo }">${board.title }&nbsp; 
																									<c:if test="${board.replyCount > 0}">
																										[${board.replyCount }]
																									</c:if>
																								</a>
																							</td>
																							<td><a href="javascript:callMsgbox('${board.userId }')" >${board.userId }</a></td>
																	...
																	<div class="form-group clearfix">
																		<input id="boardWriteView" type="button" value="글쓰기"
																	...
																	<div class="form-group ">
																		<div class="wrap_paging">
																			<form action="freeBoardView" id="boardListForm"	method="get">
																				<div class="wrap_paging-navi">
																					<a href="javascript:movepage('${currentPage-1}')">	&lt; </a>
																					<c:forEach var="num" begin="${pagenavi.startPageGroup}" end="${pagenavi.endPageGroup}">
																						<c:if test="${num ==  pagenavi.currentPage}">
																							<a href="javascript:movepage(${num})" class="selectedPn" style="color: purple;">[${num}]</a>
																						</c:if>
																						<c:if test="${num  !=  pagenavi.currentPage}">
																					...
																					<c:if test="${searchField != null && searchText!=null}">
																	...
																	<div class="form-group" align="center">
																		<div class="input-group">
																			<form id="searchform" action="freeBoardView"
																				method="get">
																				<input type="hidden" name="currentPage"
																					...
																					class="btn-group bootstrap-select form-control">
																						<option value="all"
																							<c:if test="${searchField =='all' }">selected</c:if>>전체</option>
																						<option value="title"
																							<c:if test="${searchField =='title' }">selected</c:if>>제목</option>
																						<option value="boardText"
																							<c:if test="${searchField =='boardText' }">selected</c:if>>내용</option>
																						<option value="userId"
																							<c:if test="${searchField =='userId' }">selected</c:if>>작성자</option>
																				</select>
