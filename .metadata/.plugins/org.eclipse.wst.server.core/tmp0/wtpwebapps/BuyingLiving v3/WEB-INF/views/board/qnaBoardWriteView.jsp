													...
													<div class="wpb_column vc_column_container vc_col-sm-12">
														<div class="vc_column-inner ">
															<div class="wpb_wrapper">
																...
																<form id="boardForm" name="boardForm" action="qnaBoardWrite" method="post"
																	enctype="multipart/form-data">
																	<input type="hidden" name="userId" value="${loginId }">
																	<input type="hidden" name="category" value="qnaBoard">
																		...
																		<table class="table table-striped">
																			<thead>
																				<tr>
																					...
																					<td><input type="text" id="title" name="title" size="58" required> </td>
																				</tr>
																				<tr>
																					<td align="center">내용</td>
																					<td>
																							<textarea id="boardText" name="boardText"
																								cols="120%;" rows="10%" style="padding: 10px;"
																								class="form-control" required placeholder="내용을 입력하세요"></textarea>
																					</td>
																				</tr>
																				<tr>
																	...
																	<div class="form-group clearfix">
																		<a href="qnaBoardView?currentPage=1"> <input
																			id="boardWriteCancel" type="button" value="취소"
																			class="btn pull-right btn-default"
																			style="margin-left: 15px;"></a> <input
																			id="boardWrite" type="submit" value="글쓰기"
																			class="btn pull-right btn-default">
																	</div>
																</form>
